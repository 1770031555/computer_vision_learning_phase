...
class ResNet(nn.Module):
	def __init__(self, block, layers, num_classes=120, img_size=256, dropout_factor=0.2):
		self.inplanes = 64
		...
		self.conv1 = nn.Conv2d(in_channels=3,
							   ...
							   padding=3,
							   bias=False)
		# output_height = (in_height - kernel_size + 2 * padding) / stride + 1
