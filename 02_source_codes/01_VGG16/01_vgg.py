...
from training_utils import WarmUpLR, most_recent_folder, best_acc_weights, last_epoch
...
from build_models import vgg16_bn
net = vgg16_bn()
...
if G_settings.RESUME_FLAG:
	...
	recent_weights_file = most_recent_folder(net_weights=os.path.join(G_settings.CHECKPOINT_PATH,
																	  G_settings.NET_NAME,
																	  recent_folder),
											 fmt=G_settings.DATE_FORMAT)
